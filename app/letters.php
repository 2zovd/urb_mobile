	...
	<div class="letters-list">
			...
			<div class="message-list_row">
				...
				<div class="message-list_right">
					<div class="message-list_right-top">
						<div class="message-list_notification"><span>7</span></div>
					</div>
		...
		<div class="message-list_row-wrap">
			<div class="message-list_row">
				...
				<div class="message-list_right">
					<div class="message-list_right-top">
						<div class="message-list_notification active"><span>1</span></div>
					</div>
		...
		<div class="message-list_row-wrap">
			<div class="message-list_row">
				...
				<div class="message-list_right">
					<div class="message-list_right-top">
						<div class="message-list_notification"><span>99</span></div>
					</div>
